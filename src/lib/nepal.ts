...
export const SEED_STORES = [
  {
    ...
    tagline: 'Handcrafted in Nepal, woven by hand, forged by fire.',
    ...
    supportPhone: '+977 1 4123 456',
    supportEmail: 'namaste@himalcrafts.np',
    address: 'Patan Dhoka, Lalitpur 44600, Nepal',
    socialFacebook: 'https://facebook.com/himalcrafts',
    socialInstagram: 'https://instagram.com/himalcrafts',
    socialTiktok: 'https://tiktok.com/@himalcrafts',
    socialYoutube: 'https://youtube.com/@himalcrafts',
    socialTwitter: 'https://twitter.com/himalcrafts',
    plan: 'pro',
  },
  {
    name: 'Ilam Tea Co.',
    ...
    tagline: 'From our hills to your cup — single-estate since 1987.',
    ...
    supportPhone: '+977 21 560 123',
    supportEmail: 'orders@ilamteaco.np',
    address: 'Mahmai Road, Ilam 57417, Nepal',
    socialFacebook: 'https://facebook.com/ilamteaco',
    socialInstagram: 'https://instagram.com/ilamteaco',
    socialTiktok: '',
    socialYoutube: '',
    socialTwitter: '',
    plan: 'free',
  },
  {
    ...
    tagline: 'Luxury woven at the roof of the world.',
    ...
    supportPhone: '+977 1 555 7890',
    supportEmail: 'concierge@pashminapalace.np',
    address: 'Durbar Marg, Kathmandu 44600, Nepal',
    socialFacebook: 'https://facebook.com/pashminapalace',
    socialInstagram: 'https://instagram.com/pashminapalace',
    socialTiktok: 'https://tiktok.com/@pashminapalace',
    socialYoutube: 'https://youtube.com/@pashminapalace',
    socialTwitter: '',
    plan: 'enterprise',
  },
]
...
export const SEED_PRODUCTS = [
  // ====== Himal Crafts ======
  {
    ...
    sku: 'DHAKA-TOP-001',
    variants: [
      { title: 'Small (54cm)', sku: 'DHAKA-TOP-S', price: 850, inventory: 12, attributes: { size: 'S' } },
      { title: 'Medium (56cm)', sku: 'DHAKA-TOP-M', price: 850, inventory: 18, attributes: { size: 'M' } },
      { title: 'Large (58cm)', sku: 'DHAKA-TOP-L', price: 850, inventory: 12, attributes: { size: 'L' } },
    ],
  },
  {
    storeSlug: 'himal-crafts',
  ...
  },
  {
    ...
    sku: 'JWL-PAT-TUR-R',
    variants: [
      { title: 'Size 6', sku: 'JWL-PAT-TUR-6', price: 2800, inventory: 2, attributes: { size: '6' } },
      { title: 'Size 7', sku: 'JWL-PAT-TUR-7', price: 2800, inventory: 3, attributes: { size: '7' } },
      { title: 'Size 8', sku: 'JWL-PAT-TUR-8', price: 2800, inventory: 3, attributes: { size: '8' } },
      { title: 'Size 9', sku: 'JWL-PAT-TUR-9', price: 2800, inventory: 2, attributes: { size: '9' } },
      { title: 'Size 10', sku: 'JWL-PAT-TUR-10', price: 2800, inventory: 1, attributes: { size: '10' } },
      { title: 'Size 11', sku: 'JWL-PAT-TUR-11', price: 2800, inventory: 1, attributes: { size: '11' } },
    ],
  },
  {
    storeSlug: 'himal-crafts',
  ...
  // ====== Ilam Tea Co. ======
  {
    ...
    description: 'Single-estate orthodox loose-leaf black tea from the misty hills of Ilam, eastern Nepal. First-flush harvest (March-April) yields a bright, golden liquor with notes of honey, wild flowers, and a hint of muscatel. Hand-rolled and sun-dried using traditional methods.',
    price: 950,
    inventory: 120,
    ...
    sku: 'TEA-ILM-FF',
    variants: [
      { title: '100g', sku: 'TEA-ILM-FF-100', price: 450, inventory: 60, attributes: { weight: '100g' } },
      { title: '250g', sku: 'TEA-ILM-FF-250', price: 950, inventory: 40, attributes: { weight: '250g' } },
      { title: '500g', sku: 'TEA-ILM-FF-500', price: 1700, inventory: 20, attributes: { weight: '500g' } },
    ],
  },
  {
    storeSlug: 'ilam-tea-co',
  ...
  // ====== Pashmina Palace ======
  {
    ...
    sku: 'PASH-MUS-NW',
    variants: [
      { title: 'Natural White', sku: 'PASH-MUS-NW-WHT', price: 6800, inventory: 3, attributes: { color: 'Natural White' } },
      { title: 'Soft Rose', sku: 'PASH-MUS-NW-ROSE', price: 7200, inventory: 2, attributes: { color: 'Soft Rose' } },
      { title: 'Charcoal Grey', sku: 'PASH-MUS-NW-CHR', price: 7200, inventory: 2, attributes: { color: 'Charcoal Grey' } },
      { title: 'Forest Green', sku: 'PASH-MUS-NW-GRN', price: 7200, inventory: 1, attributes: { color: 'Forest Green' } },
    ],
  },
  {
    storeSlug: 'pashmina-palace',
  ...
  },
  {
    ...
    sku: 'YAK-MUS-SW',
    variants: [
      { title: 'Small', sku: 'YAK-MUS-SW-S', price: 3200, inventory: 4, attributes: { size: 'S' } },
      { title: 'Medium', sku: 'YAK-MUS-SW-M', price: 3200, inventory: 6, attributes: { size: 'M' } },
      { title: 'Large', sku: 'YAK-MUS-SW-L', price: 3200, inventory: 5, attributes: { size: 'L' } },
      { title: 'X-Large', sku: 'YAK-MUS-SW-XL', price: 3400, inventory: 3, attributes: { size: 'XL' } },
    ],
  },
  {
    storeSlug: 'pashmina-palace',
